...
const About = () => {
    return (
        <div className='flex w-full flex-col-reverse md:flex-row  md:w-4/5 mx-auto items-center justify-between bg-gray-200 px-3 py-8'>
            {/* LEFT */}
            <div className='text-left'  style={{width: "55%"}}>
            ...
            {/* RIGHT */}
            <div style={{width: "40%", height: "500px"}} className='about-right-container'>
